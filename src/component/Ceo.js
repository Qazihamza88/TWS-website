         ...
         style={{padding:"100px 0px 30px 0px"}}>
          <div className="right-container1">
            ...
            <p style={{ fontSize: "21px", marginBottom: "26px" }}>
              Create a vision for the life you really want and then work relentlessly towards
              <br />
              making it a reality.”
            </p>
            <p style={{ fontSize: "21px", marginBottom: "26px" }}>
              ...
              TWS, I aim to help companies that are making a <br/> difference in their
              respective fields. We nourish new talent and set new <br/> standards of
            ...
            <p  style={{ fontSize: "21px", marginBottom: "25px" }}>
              ...
              the global movement of transformational tech. Therefore we<br/> will
              keep on moving forward with sheer hard work, determination and <br/>
              perseverance, and only then can we realize all our dreams!
            </p>
            <div>
            {/* <p style={{ fontSize: "21px", marginBottom: "30px" ,color:"#007EC5" }}>
                </p> */}
                <div>
